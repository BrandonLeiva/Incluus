        ...
        <div class="container-card">
            <div style="background-color: rgba(17, 24, 39, 1);" class="card">
                <div class="header-card">
                    <span class="title-card">Plan Normal</span>
                    <span class="price">9990 CLP</span>
                </div>
                <p class="desc">Tendrás la posibilidad de crear tu propio contenido educativo y realizar ejercicios</p>
                <ul class="lists">
                    <li class="list">
                        ...
                        <span>Agrega contenido educativo</span>
                    </li>
                    <li class="list">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd"
                        ...
                        <span>Agrega preguntas interactivas</span>
                    </li>
                    <li class="list">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd"
